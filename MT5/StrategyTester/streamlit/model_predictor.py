...
class ModelPredictor:
    ...
    def load_latest_model(self) -> None:
        ...
        try:
            ...
            # Load features with priority order
            self.feature_columns = None
                ...
                if os.path.exists(config_path):
                    with open(config_path, 'r') as f:
                        ...
                        if 'feature_columns' in config_data:
                            ...
                            logging.info(f"Loaded features from config.json: {len(self.feature_columns)} features")
            except Exception as e:
                logging.warning(f"Error loading features from config.json: {str(e)}")
            ...
            if not self.feature_columns:
                try:
                    ...
                    logging.info(f"Loaded features from feature_config.py: {len(self.feature_columns)} features")
