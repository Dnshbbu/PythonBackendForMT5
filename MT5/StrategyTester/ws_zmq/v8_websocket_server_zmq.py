                        ...
                        try:
                            ...
                            with open(csv_filename, 'a', newline='') as csvfile:
                                ...
                                if not file_exists:
                                    ...
                                    print(f"[{datetime.now()}] Created CSV file: {csv_filename} with headers: {csv_headers}")
                                ...
                                #     else:
                                #         print(f"[{datetime.now()}] Invalid data row format: {row}")
                            ...
                            print(f"[{datetime.now()}] IOError when handling CSV file '{csv_filename}': {io_err}")

                    else:
                        print(f"[{datetime.now()}] Missing data fields in the incoming JSON. Data: {data}")

            except zmq.Again:
                # No message received, just pass
                pass
                # Optionally, you can print or log that no data was received
                # print(f"[{datetime.now()}] No data received yet...")
