...
# Parameters
# TICKERS = ['ANTX', 'MCRB', 'HUM', 'RENB','JNJ','AZN','^GSPC']  # Updated list of stock ticker symbols
...
def main():
    ...
    starting_prices = {}  # To store starting prices per ticker
    final_prices = {}     # To store final prices per ticker
    ...
    if strategy_returns and buy_hold_returns:
        ...
        # Merge summary and trade counts
        ...
        print("\nFinal Portfolio Values with Trade Counts and Prices:")
        ...
        print("\nSummary of Final Portfolio Values, Trade Counts, and Prices:")
        print(summary_df.to_string(index=False))
