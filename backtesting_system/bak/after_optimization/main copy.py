...
from strategies import BuyAndHold, SMACrossOver, SMA_CrossOver_with_Indicators, BreakoutBullRun, SimpleCrossOver
...
def run_strategy(stock_ticker, start_date, end_date, strategy_class):
    ...
    backtest_results = run_backtest(stock_bt_feed, strategy_class, stock_ticker)
    ...
    # We'll assume the strategy saves the chart and returns the file path
