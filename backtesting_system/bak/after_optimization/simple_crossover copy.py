...
class SimpleCrossOver(bt.Strategy):
    ...
    def plot_results(self):
        ...
        fig.add_trace(go.Scatter(y=self.fast_ma_values, mode='lines', name=f'Fast MA ({self.params.fast_period})', line=dict(color='purple')))
        ...
        # Optionally, store the chart path
